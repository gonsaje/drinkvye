...
export function AddToCart() {
  ...
  return (
    <>
      <div className="mt-7 w-full min-w-0 rounded-2xl border border-palm-green/10 bg-white p-4 shadow-[0_18px_45px_rgba(31,41,51,0.06)] sm:mt-9 sm:rounded-[1.5rem] sm:p-5">
      ...
      <aside
        ...
        className={`fixed bottom-3 left-1/2 z-40 w-[calc(100vw_-_1.5rem)] max-w-3xl -translate-x-1/2 overflow-hidden rounded-2xl border border-palm-green/12 bg-white/94 p-2.5 shadow-[0_18px_50px_rgba(31,41,51,0.2)] backdrop-blur-md transition-[transform,opacity] duration-300 ease-out sm:bottom-5 sm:p-3 ${
          isMainButtonVisible
      ...
      >
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="grid min-w-0 flex-1 grid-cols-[auto_minmax(0,1fr)] gap-2 sm:flex sm:items-center sm:gap-2">
            ...
            <button
              type="button"
              onClick={handleAddToCart}
              className="inline-flex min-h-11 min-w-0 items-center justify-center rounded-xl bg-vye-pink px-3 text-xs font-black text-white shadow-[0_12px_28px_rgba(243,111,152,0.22)] transition hover:bg-[#e85f89] focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-vye-pink sm:min-h-12 sm:flex-1 sm:basis-0 sm:px-5 sm:text-sm"
            >
              Add To Cart
            </button>
            ...
            {cartQuantity > 0 ? (
              <Link
                href="/cart"
                className="col-span-2 inline-flex min-h-11 min-w-0 items-center justify-center rounded-xl border border-palm-green/15 px-3 text-xs font-black text-palm-green transition hover:border-vye-pink hover:text-vye-pink sm:col-span-1 sm:min-h-12 sm:flex-1 sm:basis-0 sm:px-5 sm:text-sm"
              >
                View Cart
              </Link>
            ) : null}
