...
export default function DrinkVyePage() {
  return (
    <div className="bg-[linear-gradient(180deg,#ffffff_0%,var(--color-coconut-cream)_26%,#ffffff_52%,#fff4f8_78%,#fde8ef_100%)]">
      <section className="relative bg-[linear-gradient(180deg,#ffffff_0%,var(--color-coconut-cream)_54%,#fff7fa_100%)] px-4 pb-16 pt-12 sm:px-8 sm:pb-32 sm:pt-28">
        <div className="relative mx-auto grid max-w-7xl min-w-0 gap-9 sm:gap-14 lg:grid-cols-2 lg:items-stretch">
          ...
          <div className="flex h-full min-w-0 flex-col">
            <h1 className="max-w-3xl text-3xl font-black leading-tight tracking-normal text-near-black sm:text-6xl">
              Vye Coconut Water
            </h1>
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#fff7fa_0%,#ffffff_100%)] px-5 pb-18 sm:px-8 sm:pb-24">
      ...
      <section className="relative bg-[linear-gradient(180deg,#ffffff_0%,#fff4f8_46%,#fde8ef_100%)] px-5 py-18 sm:px-8 sm:py-24">
        <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.78fr_1fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-near-black/66">
              About 4 servings per container. Serving size: 8 fl oz (240 mL).
              Amounts are listed per serving from the product nutrition label.
            </p>
          </div>
          ...
          <div className="bg-white p-6 shadow-[0_18px_55px_rgba(31,41,51,0.08)] sm:p-8">
            <div className="border-b-[10px] border-near-black pb-3">
              ...
              <p className="mt-1 text-base font-bold text-near-black">
