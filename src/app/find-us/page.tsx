...
export default function FindUsPage() {
  return (
    <div className="bg-[linear-gradient(180deg,var(--color-coconut-cream)_0%,#ffffff_48%,rgba(223,245,247,0.45)_72%,var(--color-palm-green)_100%)]">
      <section className="relative bg-gradient-to-b from-coconut-cream via-coconut-cream px-5 pb-28 pt-20 sm:px-8 sm:pb-32 sm:pt-28">
      ...
      <section className="relative bg-gradient-to-b via-palm-green to-palm-green px-5 py-18 text-white sm:px-8 sm:py-24">
        <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          ...
          <Button href="/contact" className="bg-white text-palm-green hover:bg-coconut-cream">
            Contact
          </Button>
        </div>
      </section>
